...
- (SEL)clientSelector
{
    ...
    @{
        ...
        @"ElasticLoadBalancingConfigureHealthCheckRequest":                       @"configureHealthCheck:",
        ...
        @"ElasticLoadBalancingDescribeLoadBalancerAttributesRequest":             @"describeLoadBalancerAttributes:",
        ...
        @"ElasticLoadBalancingModifyLoadBalancerAttributesRequest":               @"modifyLoadBalancerAttributes:",
